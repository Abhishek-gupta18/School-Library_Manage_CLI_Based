...
How to Use
Home Page — Click on any of the five service cards to access the desired feature.
Navigation Bar — Use the top menu to switch between modules at any time.
Forms — Fill in the required information and click the submit button.
Notifications — Look for green (success) or red (error) banners after each action.
Library — All books are displayed in a sortable table; use the forms to add, issue, or return books.
Data Storage
